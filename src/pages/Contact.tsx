...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const whatsappUrl = `https://wa.me/+919948332166?text=${encodedMessage}`;
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-800">Class Hours</h3>
              ...
              <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-2xl p-8">
                <h2 className="text-xl font-bold text-gray-800 mb-4">Quick Contact</h2>
            ...
            {/* Contact Form */}
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <h2 className="text-2xl font-bold text-gray-800 mb-6">Book Your Free Assessment</h2>
