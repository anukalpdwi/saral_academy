      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h1 className="text-4xl font-bold text-gray-800 mb-6">Courses Offered</h1>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg">
            <h2 className="text-2xl font-bold text-gray-800 mb-8 text-center">Course Highlights</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mb-2">Small Batch Size</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mb-2">Customized Curriculum</h3>
