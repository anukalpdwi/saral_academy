      ...
      <section className="py-20 bg-gradient-to-br from-orange-50 via-amber-50 to-red-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h1 className="text-4xl font-bold text-gray-800 mb-6">Why Choose Saral Academy</h1>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-gray-800 mb-4">Our Special Focus</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mb-3">Friendly Classes</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mb-3">Grammar Focus</h3>
