...
const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Yes, we provide comprehensive study materials including textbooks, worksheets, audio files, and digital resources. All materials are customized based on your learning level and curriculum requirements.'
    },
    {
      question: 'What is your teaching methodology?',
      answer: 'We use a multi-sensory approach combining visual, auditory, and kinesthetic learning techniques. Our methodology focuses on practical application, regular practice, and gradual skill building with continuous assessment and feedback.'
    },
    {
      question: 'How do you track student progress?',
      answer: 'We maintain detailed progress reports, conduct regular assessments, provide feedback after each session, and share monthly progress updates with students and parents. We also adjust teaching methods based on progress.'
    },
    {
      question: 'What are your fees and payment options?',
      answer: 'Our fees are competitive and vary based on the course and duration. We offer flexible payment options including monthly, quarterly, and course-wise payments. Contact us for detailed fee structure and available discounts.'
    }
  ];
