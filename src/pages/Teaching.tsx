...
import { Brain, Eye, Ear, Hand, Target, BookOpen, Edit, Headphones } from 'lucide-react';
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h1 className="text-4xl font-bold text-gray-800 mb-6">Our Teaching Approach</h1>
          ...
          <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-2xl p-8 mb-16">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl font-bold text-gray-800 mb-4">Personalized Assessment</h2>
            ...
            <div className="grid md:grid-cols-4 gap-6">
              <div className="text-center">
                ...
                <h3 className="font-semibold text-gray-800 mb-2">Initial Evaluation</h3>
          ...
          <div className="mb-16">
            <h2 className="text-3xl font-bold text-gray-800 text-center mb-12">Learning Styles We Support</h2>
              ...
              {learningStyles.map((style, index) => {
                ...
                return (
                  <div key={index} className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100">
                    ...
                    <h3 className="text-xl font-semibold text-gray-800 text-center mb-3">{style.title}</h3>
          ...
          <div className="bg-gray-50 rounded-2xl p-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="bg-white rounded-xl p-6 text-center shadow-sm hover:shadow-md transition-shadow">
                ...
                <h3 className="font-semibold text-gray-800 mb-2">Comprehension</h3>
